...
$resticker = $kraken->QueryMarket('buylimit',$marketrequest);

if ($resticker['success'] == true) {echo 'buyorder successfully placed';}
else {echo 'buy order failed';}

} else { echo 'buy order failed, postdata not correct';} 
